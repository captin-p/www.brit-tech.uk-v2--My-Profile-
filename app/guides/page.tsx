  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-16 md:py-24">
      <header className="max-w-3xl">
        ...
        <Link href="/briefings" className="mt-6 inline-flex text-sm font-semibold text-primary hover:underline">Looking for current developments? Read the Daily Tech Briefings →</Link>
      </header>
