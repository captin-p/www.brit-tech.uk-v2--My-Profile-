...
const profileDataByLanguage = {
  en: {
    profile: {
      ...
      summary:
        "CCNA-certified network infrastructure specialist with 6+ years of experience delivering enterprise IT solutions across education, healthcare, and commercial sectors. Founder of an IT company managing end-to-end infrastructure projects serving 1,000+ users. Strong hands-on expertise in Cisco and Ubiquiti deployments, CCTV security systems, Windows Server administration, and Active Directory.",
      about: [
  ...
  fr: {
    profile: {
      ...
      linkedin: "https://www.linkedin.com/in/bright-konadu",
      summary:
        "Specialiste en infrastructure reseau certifie CCNA avec plus de 6 ans d'experience dans la mise en oeuvre de solutions IT pour les secteurs de l'education, de la sante et des entreprises. Fondateur d'une societe IT ayant pilote des projets d'infrastructure de bout en bout pour plus de 1 000 utilisateurs. Solide experience pratique en deploiement Cisco et Ubiquiti, systemes CCTV, administration Windows Server et Active Directory.",
      about: [
